...
$(document).ready(function(){
	...
	$("#dateForm :input[name=termInfo]").click(function(){
		...
		location.href="adminDealDetailByDate_result2.bank?gapChecked="+$("#dateForm :input[name=termInfo]:checked").val()+"&dealType="+$("#dateForm :input[name=dealType]").val()+"&accountNo="+"<%=request.getParameter("accountNo")%>"+"&page=1"
	});//form click2
});//document
</script>
...
<br><br>
   ...
   <a href="adminDealDetailByDate_result.bank?page=${pb.startPageOfPageGroup-1}&accountNo=<%=request.getParameter("accountNo")%>&dealType=<%=request.getParameter("dealType")%>&startDay=<%=request.getParameter("startDay")%>&endDay=<%=request.getParameter("endDay")%>">
   ...
   <a href="adminDealDetailByDate_result.bank?page=${i}&accountNo=<%=request.getParameter("accountNo")%>&dealType=<%=request.getParameter("dealType")%>&startDay=<%=request.getParameter("startDay")%>&endDay=<%=request.getParameter("endDay")%>">
   ${i}
   </a>
   </c:when>
   <c:otherwise>
   ...
   <a href="adminDealDetailByDate_result.bank?page=${pb.endPageOfPageGroup+1}&accountNo=<%=request.getParameter("accountNo")%>&dealType=<%=request.getParameter("dealType")%>&startDay=<%=request.getParameter("startDay")%>&endDay=<%=request.getParameter("endDay")%>">
