...
public class SecureCardController {
   ...
   ///////////////////////////////////////////////////////////////
   @RequestMapping("createSecureCard.bank")
   public ModelAndView createSecureCard(String email) {
      return new ModelAndView("kangbank_admin/popup/secureCard", "email", email);
   }
   
	@RequestMapping("adminRegisterSecureCard.bank")
	@ResponseBody
	public String adminRegisterSecureCard(String email){
		System.out.println("start");
		CustomerVO vo = customerService.customerInfo(email);
		String msg="";
		if(vo!=null){
			SecureCardVO scvo = new SecureCardVO(vo.getEmail());
			service.registerSecureCard(scvo,vo);
