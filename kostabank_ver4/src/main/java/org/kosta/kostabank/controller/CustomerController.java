...
public class CustomerController {
   ...
   ///////////////////////////////////////////////////////////////
   /////// title : adminCustomerRegister                        ///////
   /////// dec : 회원가입 성공                                       ///////
   ///////////////////////////////////////////////////////////////
   @RequestMapping(value = "adminCustomerRegister.bank", method = RequestMethod.POST)
   public String adminCustomerRegister(CustomerVO vo) {
      String url = "kangbank_admin/popup/closeWindow";
      customerService.customerRegister(vo);
      return url;
   }
   
   ///////////////////////////////////////////////////////////////
   /////// title : adminGoRegister                        ///////
   /////// dec : 회원가입페이지로 이동                                ///////
   ///////////////////////////////////////////////////////////////
   @RequestMapping(value = "adminGoRegister.bank", method = RequestMethod.POST)
   public ModelAndView adminGoRegister(CustomerVO vo) {
      return new ModelAndView("kangbank_admin/popup/register");
   }
   ///////////////////////////////////////////////////////////////
   /////// title : checkEmail                              ///////
   /////// dec : 아이디 중복 여부 확인                               ///////
